...
{
    public partial class TravelExperts_Group3Context : DbContext
    {
        public TravelExperts_Group3Context()
        {
        }

        public TravelExperts_Group3Context(DbContextOptions<TravelExperts_Group3Context> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Agents>(entity =>
            {
                ...
                entity.Property(e => e.AgtPassword)
                    .HasMaxLength(20)
                    .IsFixedLength();
            ...
            modelBuilder.Entity<Packages>(entity =>
            {
                ...
                entity.Property(e => e.AlternativeText).HasMaxLength(100);
